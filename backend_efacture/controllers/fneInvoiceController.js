...
const sendRefund = async (req, res) => {
  try {
    ...
    const fneApiBaseUrl = process.env.FNE_API_URL || 'http://54.247.95.108/ws/external/invoices/sign';
    const fneApiToken = process.env.FNE_API_TOKEN || 'xOUe2t01VwGqGgA2VG6yStihUmmg30Jm';
