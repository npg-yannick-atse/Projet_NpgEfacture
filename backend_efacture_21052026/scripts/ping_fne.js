 ...
 *   node scripts/ping_fne.js --url=https://www.services.fne.dgi.gouv.ci/ws/external/invoices/sign
 */
...
const FNE_URL = args.url || process.env.FNE_API_URL || 'https://www.services.fne.dgi.gouv.ci/ws/external/invoices/sign';
